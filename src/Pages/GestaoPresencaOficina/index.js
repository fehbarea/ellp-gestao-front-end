import style from './GestaoPresencaOficina.module.css';
...
function GestaoPresencaOficina() {
  ...
  return (
    <article className={style.GestaoPresencaOficina}> 
      <Header />
      <section>
        <NomePags
          nome='Presença Oficina' />
        <Datagrid
...
export default GestaoPresencaOficina;